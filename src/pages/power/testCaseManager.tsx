...
import { getTestCaseManager as apiGetList, delMenu } from "@/api";
import MyTable from "@/components/table";
import MyIcon from "@/components/icon";
import { MenuList, MapKey } from "@/types";
import "./index.less";
import TestCaseManagerModal from "@/components/modal/testCaseManager";
  ...
  return (
    <div className="powermenu-container">
      ...
      <TestCaseManagerModal
        ...
        updateMenu={getTestCaseList}
      />
    </div>
  );
}

TestCaseManager.route = {
  [MENU_PATH]: "/power/testCaseManager",
};
