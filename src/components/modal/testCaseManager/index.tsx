...
const initFormItems: FormItemData[] = [
  {
    itemType: "input",
    itemProps: {
      rules: [{ required: true, message: "请填写测试工具名称" }],
      label: "测试工具",
      name: "toolName",
    },
    childProps: {
      placeholder: "请填写测试工具名称",
    },
  },
  {
    itemType: "input",
    itemProps: {
      rules: [{ required: true, message: "请填写测试方向" }],
      label: "测试方向",
      name: "testDirection",
    },
    childProps: {
  ...
  },
  {
    itemType: "input",
    itemProps: {
      rules: [{ required: true, message: "请填写测试用例" }],
      label: "测试用例",
      name: "testCase",
    },
    childProps: {
  ...
  },
  {
    itemType: "input",
    itemProps: {
      rules: [{ required: true, message: "请填写测试内容" }],
      label: "测试内容",
      name: "testContent",
    },
    childProps: {
  ...
  },
  {
    itemType: "input",
    itemProps: {
      rules: [{ required: true, message: "请填写测试方法" }],
      label: "测试方法",
      name: "testMethod",
    },
    childProps: {
...
export default function TestCaseManagerModal({
  info,
  modalType = "add",
  isShow,
  setShow,
